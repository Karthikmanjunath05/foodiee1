<%@page import="com.Foodie.Registration.productobj" %>
<%@page import="com.Foodie.Registration.productdao" %>
<%@page import="com.Foodie.Registration.DbCon" %>
...
<div class="container" style="margin-top:30px">
	<div class="row" style="width:100%;height:100%">
		<div class="col-md-6 my-6 " style="display:flex;flex-direction:column;justify-content:center">
			...
			<br>
			<button type="button" class="btn btn-lg btn-danger">Start ordering now</button>
		</div>
